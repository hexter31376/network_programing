 ...
 *                                                   next1.proceed()
 *                                                       chain(index=2)  →  methodProxy.invokeSuper() (실제 메서드)
 * </pre>
 *
 * <p>{@code @FunctionalInterface}는 아니지만 {@link ProxyFactory} 내부에서
...
public interface MethodInvocation {
     ...
     *
     * <p>인터셉터 목록이 소진되면 CGLIB의 {@code methodProxy.invokeSuper()}를 호출하여
     * 실제 빈의 메서드를 실행한다.</p>
     *
     * @return 실제 메서드의 반환값
