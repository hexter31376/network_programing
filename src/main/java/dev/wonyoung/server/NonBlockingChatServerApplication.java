...
import dev.wonyoung.server.adapter.in.socket.nonblocking.NonBlockingServer;
...
public class NonBlockingChatServerApplication {

    public static void main(String[] args) throws Exception {
        Container container = new Container("dev.wonyoung.server");

        ChatServer server = new NonBlockingServer(
